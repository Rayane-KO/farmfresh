...
urlpatterns = [
    ...
    path("<str:pk>/<str:type>/add-to-cart/", CartAddItem.as_view(), name="add_to_cart"),
    path("<str:pk>/<str:type>/remove-from-cart/", CartRemoveItem.as_view(), name="remove_from_cart"),
